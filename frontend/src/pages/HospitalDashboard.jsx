...
import { 
  ...
  Pill, QrCode, Layers, Save, Trash2, FileText, Eye, Building2, Globe, Timer, Zap, Brain, Cpu, Terminal, TrendingUp, ClipboardList, Filter, MessageCircle, AlertTriangle, Send
} from 'lucide-react';
...
const HospitalDashboard = () => {
    ...
    try {
      ...
      if (Array.isArray(data)) {
        ...
        if (activeChatRequest) {
            const updated = sortedData.find(r => r._id === activeChatRequest._id);
  ...
  const sendMessage = async () => {
      ...
      try {
          ...
          setChatMessage("");
          fetchRequests(); // Refresh to see new message
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-slate-800 flex items-center gap-2">
                                        ...
                                        {hasIncident && <span className="bg-red-100 text-red-600 px-2 py-0.5 rounded text-[10px] font-bold flex items-center gap-1"><AlertTriangle size={10}/> ISSUE</span>}
                                    </h3>
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col h-[500px]">
                <div className="bg-blue-600 p-4 flex justify-between items-center text-white">
                    <h3 className="font-bold flex items-center gap-2"><MessageCircle size={18}/> Chat: {activeChatRequest.phc}</h3>
