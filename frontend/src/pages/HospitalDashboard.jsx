...
const HospitalDashboard = () => {
  ...
  const [viewItemList, setViewItemList] = useState(null); // ✅ PACKING LIST STATE
  ...
  const fetchPredictions = async () => {
    try {
        ...
        console.log("AI Offline, using mock");
        const mockData = [
  ...
  const handleAutoDispatch = (req) => {
    ...
    // ✅ EXACT GPS LOCATION (Req coordinates)
  ...
  return (
    <div className={`min-h-screen bg-slate-50 flex font-sans text-slate-800 relative`}>
      ...
      {/* ✅ CORRECT AI COPILOT (Using 'requests' instead of 'orderHistory') */}
