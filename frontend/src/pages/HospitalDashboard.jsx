...
// ✅ 1. CORRECTED PHC COORDINATES (8 PHCs ONLY)
...
const HospitalDashboard = () => {
  ...
  const [viewItemList, setViewItemList] = useState(null); // ✅ Feature: Packing List
  ...
  // ✅ FETCH AI PREDICTIONS (Corrected Mock Data - No Wagholi)
